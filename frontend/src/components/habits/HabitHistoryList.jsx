...
function HabitHistoryList({ 
   ...
   */
  const habitConfig = {
    hydration: { icon: '💧', name: 'Hydration', color: 'blue' },
    nutrition: { icon: '🍽️', name: 'Nutrition', color: 'green' },
    workout: { icon: '💪', name: 'Workout', color: 'orange' },
    meditation: { icon: '🧘', name: 'Meditation', color: 'purple' },
    sleep: { icon: '😴', name: 'Sleep', color: 'indigo' },
    default: { icon: '✅', name: 'Habit', color: 'gray' }
  };
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                {/* Right: Success indicator & delete button */}
                <div className="flex items-center gap-2">
                  {log.success ? (
